...
class LearningAgent(Agent):
	...
	#state = conStr(waypoint) +"_" +conStr(inputs['light']) + "_" + conStr(inputs['left']) + "_" + conStr(inputs['right']) + "_" + conStr(inputs['oncoming'])
	state = conStr(waypoint) +"_" +conStr(inputs['light']) + "_" + conStr(inputs['left']) + "_" + conStr(inputs['oncoming'])
	if self.learning:
